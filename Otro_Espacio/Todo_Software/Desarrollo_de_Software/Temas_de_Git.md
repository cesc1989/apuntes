...
# Auto completar comandos con aliases de shell
...
# Listar commits desde hasta

Quería listar una serie de commits desde un punto hasta el más reciente. Se logra con `git log hash..` o `git rev-list hash..`.

Con git rev-list sale así:
```bash
git rev-list 72c3da86ea16611e4711ce58d30910b8f6b16b7b..HEAD
837aab2b94725ecfceea313bee0365d4c770c89a
42d1639c51fa1da2078aded72e68e979eb700f8c
d49789c66753cb5620755a4df876c140025611a4
e22a9cc9db82b6cf7f624f313ccc2affcc72a639
8028ca21d4af5584f74187df5b885361b112aa94
ed7d0010eb4e8dcec3777596a745c11f40f81cbe
a4f8f7a75fbc3969f2074b4495fe648ce50bda36
5457e3162e6d439284ace896cb779fbd7b39ba17
25f0a9ee13d02232296d1cd450854b85c11d8883
1df1fbf9e53b9dff09551b1858d38061baef4837
```

Con git log ya puedo usar las banderas que conozco:
```bash
git log --oneline 72c3da86ea16611e4711ce58d30910b8f6b16b7b^..HEAD
837aab2 (HEAD -> master, origin/master, origin/HEAD) Auhor Francisco Quikntero para posts
42d1639 objeto Service para Schema.org
d49789c schema de json ld para ProfessionalService
e22a9cc configura permalinkst
8028ca2 Fecha del post o pagina en espanol
ed7d001 agrega llms
a4f8f7a se explicito con que se permiten los bots de ia para este sitio
5457e31 exclude plans folder from jekyll build
25f0a9e carpeta de planes para clauidio y otras ias
1df1fbf correccion de meta etiqueta title
72c3da8 GEO preps: no mencionar canonical para posts quie estaban en wordpress
```

Visto en Stack Overflow: https://stackoverflow.com/a/7693298/1407371